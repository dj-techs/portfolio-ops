...
**Goal:** Build, push, and continuously improve 12 demoable AI/ML engineering repos under github.com/dj-techs, with a self-sustaining loop of trending intake → issue creation → scoped work sessions → memory-aware execution.
...
A scheduled GitHub Actions workflow runs in a dedicated repo `dj-techs/portfolio-ops` and creates issues across the twelve portfolio repos based on what's surfacing in the AI/ML/full-stack ecosystem.
...
3. Create `dj-techs/portfolio-ops` repo. Push the trending workflow, the init script, and this handoff document.
...
- [ ] All 12 repos exist on github.com/dj-techs with v0.1 published.
