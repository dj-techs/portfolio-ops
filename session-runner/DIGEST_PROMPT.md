...
You are writing JT's Monday-morning portfolio digest. Goal: a scannable brief of the past 7 days across the 12 portfolio repos under `github.com/jt-mchorse`, plus `portfolio-ops`.
...
3. If `jt-mchorse/portfolio-ops` has Discussions enabled (check via `gh api /repos/jt-mchorse/portfolio-ops --jq .has_discussions`):
   - Get the categories: `gh api /repos/jt-mchorse/portfolio-ops/discussions/categories`
